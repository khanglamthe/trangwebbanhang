<?php
	...
	if(isset($_SESSION['product'])){if(isset($_SESSION['dangnhap'])){
	...
	foreach($_SESSION['product'] as $cart_item){
			...
			echo'<td><img src="../modules/quanlihanghoa/uploads/'.$dong['hinhanh'].'" width="100" height="100" /></td>';
			...
			$tongtien=0;
			$tongtien=$cart_item['SoLuongHangHoa']*$cart_item['gia'];
